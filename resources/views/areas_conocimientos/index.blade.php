        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('areas_conocimientos.agregar')}}">Agregar</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    <form name="formBuscar" action="{{route("areas_conocimientos.index")}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            @foreach($areas_conocimientos as $area_conocimiento)
                                <tr>
                                    ...
                                    <td>{{$area_conocimiento->nombre}}</td>
                                    <td>

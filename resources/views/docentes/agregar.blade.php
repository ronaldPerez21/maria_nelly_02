            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{route("docentes.insertar")}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Codigo_Docente:<i class="text-danger">*</i></label>
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="codigo_docente" value="{{old('codigo_docente')}}" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <button class="btn btn-danger " type="button" onclick="location.href='{{route('docentes.index')}}'">Cancelar</button>
    ...
    <script>
        $(document).ready(function(){
            $('#txtPersona').keyup(function(){
                var nombre=$(this).val();
                if(nombre.length>=3){
                    $.get('{{route('docentes.personasActivas')}}?q='+nombre, function(data){

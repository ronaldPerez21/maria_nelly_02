        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('personas.agregar')}}">Agregar</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    <form name="formBuscar" action="{{route("personas.index")}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            @foreach($personas as $persona)
                                <tr>
                                    ...
                                    <td>{{$persona->ci.' '.$persona->ci_exp}}</td>
                                    ...
                                    <td>{{fecha_latina($persona->created_at) }}</td>
                                    <td>{{fecha_latina($persona->updated_at) }}</td>
                                    <td data-texto="{{$persona->nombres}}">
                                        <a href="{{route('personas.mostrar',$persona->id)}}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
                                        <a href="{{route('personas.modificar',$persona->id)}}" title="Modificar"><img width="17px" src="{{asset('img/iconos/modificar.png')}}" alt="Modificar"></a>
                                        <a data-ruta="{{route('personas.eliminar',$persona->id)}}" class="btn-eliminar" title="Eliminar"><img width="17px" src="{{asset('img/iconos/eliminar.png')}}" alt="Eliminar"></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>

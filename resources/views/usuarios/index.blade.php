        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('usuarios.agregar')}}">Agregar</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    <form name="formBuscar" action="{{route("usuarios.index")}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            ...
                            @foreach($usuarios as $usuario)
                                <tr>
                                    ...
                                    <td>{{fecha_latina($usuario->created_at) }}</td>
                                    <td>{{fecha_latina($usuario->updated_at) }}</td>
                                    <td data-texto="{{$usuario->login}}">

        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <a class="btn btn-primary" href="{{route('niveles.agregar')}}">Agregar</a>
                    <div class="ibox-tools"><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></div>
                </div>
                <div class="ibox-content">
                    <form name="formBuscar" action="{{route("niveles.index")}}" method="get">
                        <div class="row">
                        ...
                        <tbody>
                            @foreach($niveles as $nivel)
                                <tr>
                                    ...
                                    <td>{{fecha_latina($nivel->created_at) }}</td>
                                    <td data-texto="{{$nivel->nombre}}">
                                        <a href="{{route('niveles.mostrar',$nivel->id)}}" title="Mostrar"><img width="17px" src="{{asset('img/iconos/mostrar.png')}}" alt="Mostrar"></a>
                                        <a href="{{route('niveles.modificar',$nivel->id)}}" title="Modificar"><img width="17px" src="{{asset('img/iconos/modificar.png')}}" alt="Modificar"></a>
                                        <a data-ruta="{{route('niveles.eliminar',$nivel->id)}}" class="btn-eliminar" title="Eliminar"><img width="17px" src="{{asset('img/iconos/eliminar.png')}}" alt="Eliminar"></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>

            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form action="{{route("gestiones.insertar")}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="fecha_inicio_clases" value="{{old('fecha_inicio_clases')}}" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10"><input type="date" class="form-control" name="fecha_final_clases" value="{{old('fecha_final_clases')}}" required=""></div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="numeros_periodos" value="{{old('numeros_periodos')}}" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="tipos_periodos"  id="tipos_periodos">
                                        <option value="BI" @if(old('tipos_periodos')=='BI') selected="" @endif>BIMESTRAL</option>
                                        <option value="TRI" @if(old('tipos_periodos')=='TRI') selected="" @endif>TRIMESTRAL</option>
                                    </select>
                                </div>
                            </div>
